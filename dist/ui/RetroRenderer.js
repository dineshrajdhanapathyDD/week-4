...
export class RetroRenderer {
     ...
     */
    updateUIElements(score, aiExplanation) {
     ...
     */
    renderCell(position, color, isHead = false, isFood = false) {
        const x = position.x * this.cellSize;
        const y = position.y * this.cellSize;
     ...
     */
    applyCRTCurvature() {
        if (this.retroEffects.crtCurvature <= 0)
            return;
     ...
     */
    renderPixelArt(sprite, position) {
     ...
     */
    detectGameStateChanges(gameState) {
...
//# sourceMappingURL=RetroRenderer.js.map