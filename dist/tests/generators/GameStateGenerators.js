 ...
 */
export const positionGenerator = (gridWidth = 20, gridHeight = 20) => fc.record({
 ...
 */
export const directionGenerator = () => fc.constantFrom(Direction.UP, Direction.DOWN, Direction.LEFT, Direction.RIGHT);
/**
 * Generates valid snake segments
 */
export const snakeSegmentGenerator = (gridWidth = 20, gridHeight = 20) => fc.record({
 ...
 */
export const snakeGenerator = (gridWidth = 20, gridHeight = 20) => fc.array(snakeSegmentGenerator(gridWidth, gridHeight), { minLength: 1, maxLength: 10 });
/**
 * Generates valid game states for testing
 */
export const gameStateGenerator = () => fc.record({
 ...
 */
export const validFoodPositionGenerator = (snake) => {
    const occupiedPositions = snake.map(segment => segment.position);
    return positionGenerator().filter(pos => !occupiedPositions.some(occupied => occupied.x === pos.x && occupied.y === pos.y));
};
//# sourceMappingURL=GameStateGenerators.js.map